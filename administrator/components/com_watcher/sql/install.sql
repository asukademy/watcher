...
CREATE TABLE IF NOT EXISTS `#__watcher_sites` (
...
INSERT INTO `#__watcher_sites` (`id`, `asset_id`, `catid`, `title`, `alias`, `url`, `introtext`, `fulltext`, `images`, `version`, `created`, `created_by`, `modified`, `modified_by`, `ordering`, `state`, `publish_up`, `publish_down`, `checked_out`, `checked_out_time`, `access`, `language`, `params`) VALUES
