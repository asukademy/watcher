...
<!-- LIST TABLE -->
<table id="backupList" class="table table-striped adminlist">
...
<tr>
	...
	<th width="5%" class="nowrap center">
		<?php echo $grid->sortTitle('JSTATUS', 'backup.state'); ?>
	</th>

	<!--TITLE-->
	<th class="center">
		<?php echo $grid->sortTitle('JGLOBAL_TITLE', 'backup.title'); ?>
	</th>
	...
	<!--CREATED-->
	<th width="10%" class="center">
		<?php echo $grid->sortTitle('JDATE', 'backup.created'); ?>
	</th>
	...
	<th width="1%" class="nowrap center">
		<?php echo $grid->sortTitle('JGRID_HEADING_ID', 'backup.id'); ?>
	</th>
</tr>
</thead>
...
<?php foreach ($data->items as $i => $item)
	...
	$grid->setItem($item, $i);
	?>
	<tr class="backup-row" sortable-group-id="<?php echo $item->catid; ?>">
		<!-- DRAG SORT -->
		...
		<!--CHECKBOX-->
		<td class="center">
			<?php echo JHtml::_('grid.id', $i, $item->backup_id); ?>
		</td>
